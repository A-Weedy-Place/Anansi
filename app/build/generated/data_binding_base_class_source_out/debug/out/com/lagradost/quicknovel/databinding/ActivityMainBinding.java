...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull FrameLayout rootView, @NonNull FrameLayout container,
      @NonNull FrameLayout homeRoot, @NonNull BottomNavigationView navView) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.homeRoot;
      FrameLayout homeRoot = ViewBindings.findChildViewById(rootView, id);
      if (homeRoot == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((FrameLayout) rootView, container, homeRoot, navView);
    }
